...
public class ShadowHull extends ConvexHull {
	...
	public void setPos(Vec2 newPos) {
		...
		for (Vec2 point : shapePoints) {
			...
			newPointX = (newPointX - camera.position.x) + Camera.center.x;
			newPointY = (newPointY + camera.position.y) - Camera.center.y;
	...
	public void rotate(float angle, int originX, int originY)
	{
		...
		*/
		...
		for (Vec2 point : shapePoints) {
			...
			/*System.out.println("pointX: " + newPointX);
			System.out.println("pointY: " + newPointY);//*/
		}
